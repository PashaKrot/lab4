...
class Employee_accounting(object):
    def show_teh(self):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(320, 50, 131, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(320, 30, 151, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Employee_num"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Get_employee_data"))
        self.pushButton.setText(_translate("MainWindow", "Update_employee_data"))
        self.pushButton_2.setText(_translate("MainWindow", "Add_employee_data"))
        self.pushButton_3.setText(_translate("MainWindow", "Delete_employee_data"))
    ...
    def change(self):
        ...
        try:
            Employee_num = int(self.lineEdit.text())
        ...
        try:
            ...
            cur = db.cursor()
            ch1="""UPDATE technics SET firstname = %s, lastname = %s, position = %s,Division_Division_num = %s WHERE Employee_num = %s"""
            ch2=( firstname, lastname, position, Employee_num)
            cur.execute(ch1, ch2)
            db.commit()
            cur.close()
        finally:
    ...
    def add(self):
        ...
        cur.execute('insert into technics values(%s, %s, %s, %s, %s)', \
            (int(Employee_num), firstname, lastname, position,))
        db.commit()
    ...
    def dels(self):
        ...
        try:
            ...
            return
        cur.execute("DELETE FROM technics WHERE Employee_num= %s",(int(ids),))
        db.commit()
        cur.close()
        db.close()
