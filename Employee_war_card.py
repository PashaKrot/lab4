...
class  Empl(object):
    ...
    def loadconection(self):
        ...
        with db:
            ...
            rows = cur.execute("""select * from Warehouse_registration_card""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['Warehouse_number', 'Date', 'Name_of_inventory', 'Number_of_inventory_items', 'Firstname', 'Lastname', 'Position'])
